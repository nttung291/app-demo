  ...
  return (
    <Svg width={24} height={24} viewBox="0 0 256 256">
      <G transform="translate(1.41 1.41) scale(2.81 2.81)">
        ...
        />
        <Path
          d="M 58.997 67.302 l -13.939 -10.41 L 31.187 67.404 l 5.159 -17.082 L 22.5 39.774 l 17.13 -0.147 l 5.313 -17.031 l 5.427 16.992 L 67.5 39.61 L 53.725 50.258 l 5.273 17.045 L 58.997 67.302 z"
          fill="#FFFF00"
        />
      </G>
    </Svg>
